                        ...
                        @foreach($menu['children'] as $item)
                            ...
                            @if(isset($item['gate']))
                                @can($item['gate'])
                                    <div class="menu-item ">
                                        <!--begin:Menu link-->
                                        <a class="menu-link @if($menu_parent == $menu['name'] && $menu_child == $item['name']) active @endif  ms-4 "
                                           href="@if(isset($item['route'])) {{route($item['route'])}} @else # @endif">
                                                <span class="menu-bullet">
                                                    <span class='@if(isset($item['icon'])) {{$item['icon']}} @else bullet bullet-dot @endif'></span>
                                                </span>
                                            <span style="font-size: smaller" class="menu-title ">{{$item['title']}}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                @endcan
