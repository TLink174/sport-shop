    ...
    <form action="{{route('admin.users.store')}}" method="post" class="form-control-sm">
        ...
        <div class="mb-10">
            ...
            <input name="email" type="text" class="form-control form-control-solid"
                   placeholder="Enter name category" {{old('email')}}>
        </div>
        <div class="mb-10">
        ...
        <div class="mb-10">
            ...
            <select class="form-select form-select-solid " data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple" name="roles[]">
