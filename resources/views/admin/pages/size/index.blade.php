...
@section('title_page')
    List Size - Admin - {{ config('app.name') }}
@endsection
@section('name_user')
    Nam 077
@endsection
...
@section('actions_layout')
    @can('size-create')
        <a href="{{route('admin.size.create')}}" class="btn btn-primary">
            <i class="fa fa-plus"></i> Create Size
        </a>
    @endcan
@endsection
@section('title_card')
    ...
    <div class="table-responsive">
        <table id="kt_datatable_horizontal_scroll" class="table table-row-dashed gy-5 gs-7">
            ...
            <tr class="fw-semibold fs-6 text-gray-800">
                ...
                <th class="min-w-200px">Name size</th>
                @if(auth()->user()->can('size-update') || auth()->user()->can('size-delete') || auth()->user()->can('size-restore'))
            ...
            @foreach($sizes as $size)
                <tr>
                    ...
                    <td>
                        ...
                        @else
                                <a href="{{route('admin.size.restore',$size->id)}}"
