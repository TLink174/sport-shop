...
@section('content_card')
    <form action="{{route('admin.product-category.update', $category->id)}}" method="post" class="form-control-sm">
        @csrf
        <div class="mb-10">
        ...
        <div class="mb-10">
            ...
            <textarea name="description" id="" cols="20" rows="10"
                      class="form-control form-control-solid">{{$category -> description}}</textarea>
        </div>
        <div class="mb-10">
